...
<div class="py-0">
    <div class="text-center " style="
        ...
        <h1 class="text-white fs-3 fw-bolder" style="margin-top: 0px;"><%=user.getuId()%></h1>
        ...
        <table class="table table-stripped" align="center">
            ...
            <tr>
                <div class="pw">
                    ...
                    <td style="vertical-align: middle"><%=user.getPw()%></td>
                </div>
            </tr>
            <tr>
                <div class="uName">
                    <th style="vertical-align: middle">이름</th>
                    <td style="vertical-align: middle"><%=user.getuName()%></td>
                </div>
            </tr>
            <tr>
                <div class="hp">
                    <th style="vertical-align: middle">전화번호</th>
                    <td style="vertical-align: middle"><%=user.getHp()%></td>
                </div>
            </tr>
            <tr>
                <div class="addr">
                    <th style="vertical-align: middle">주소</th>
                    <td style="vertical-align: middle"><%=user.getAddr()%></td>
                </div>
            </tr>
            <tr>
